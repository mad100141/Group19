...
ggplot(south_america, aes("Central government debt, total (% of GDP", "Military expenditure")) + geom_point() + 
  labs(
    title = "Government Debt vs Military Expenditure",
    x = "Central government debt total (% of GDP)",
    y = "Military expenditure (% of GDP)"
  ) + theme_dark() + scale_color_brewer(palette = "RdYlBu")

ggplot(south_america, aes("GDP (current LCU)", "Mortality rate, under-5 (per 1,000)")) + geom_point() + 
  labs(
