...
Variables <- merge(Variables, filter(indicators, IndicatorCode=="SP.DYN.LE00.IN" &  Year==2012), by = 'CountryCode')
...
#actually GDP^1/4 vs Life expectancy at birth, total (years)
...
1st Graph:
The graph shows life expectancy versus a country's GDP^(1/4). It seems that there is a general upward trend, as a Country's GDP rises, the life expectancy will increase. This is due in part to better healthcare in richer nations. In fact, five out of the seven world powers have life expectancies above the trend line, while one is on and one is below the line. Even if some of the world powers do not have the highest GDP, most are at the top in regards to life expectancy.
