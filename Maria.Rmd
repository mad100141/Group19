...
ggplot(world_muerte, aes(x = Year, y = Value, color = CountryName)) + geom_line()

world_pobreza <- world_power_M %>%
...
world_df <- subset(indicators,
                   IndicatorName %in% pairs &
                   CountryName %in% world_powers)

#Grid Maps of Mortality Rate
